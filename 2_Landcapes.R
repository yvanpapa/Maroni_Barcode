...
dir.create("outputs/all_species")

#LEGEND=10 VERSION
colorRampPalette(cols_tr,alpha=T)->colfunc
colfunc(1000)->cols_gr

pdf(paste0("outputs/all_species/All_species_norm.pdf"))
...
png(paste0("outputs/all_species/All_species_norm.png"))
plot(basemap,col=(pal(1000)), ext=ext_basemap,colNA="dodgerblue3",legend=FALSE,main="All species")
plot(maroni_basins,add=T) #Bassins versants noir
draw.shape(maroni_rivs, type = "lines", col = "dodgerblue3", lwd=1)
plot(rnorm_xyz_total.masked,col=cols_tr,add=T,legend=F,zlim = c(0,1))
...
pdf(paste0("outputs/all_species/All_species_norm_grad.pdf"))
plot(basemap,col=(pal(1000)), ext=ext_basemap,colNA="dodgerblue3",legend=FALSE,main="All species")
plot(maroni_basins,add=T) #Bassins versants noir
draw.shape(maroni_rivs, type = "lines", col = "dodgerblue3", lwd=1)
...
png(paste0("outputs/all_species/All_species_norm_grad.png"))
plot(basemap,col=(pal(1000)), ext=ext_basemap,colNA="dodgerblue3",legend=FALSE,main="All species")
plot(maroni_basins,add=T) #Bassins versants noir
draw.shape(maroni_rivs, type = "lines", col = "dodgerblue3", lwd=1)
plot(rnorm_xyz_total.masked,col=cols_gr,add=T,legend=F,zlim = c(0,1))
...
pdf(paste0("outputs/all_species/count_nb_species.pdf"))
...
png(paste0("outputs/all_species/count_nb_species.png"))
plot(basemap,col=(pal(1000)), ext=ext_basemap,colNA="dodgerblue3",legend=FALSE,main="Number of species computed by pixel")
plot(maroni_basins,add=T) #Bassins versants noir
draw.shape(maroni_rivs, type = "lines", col = "dodgerblue3", lwd=1)
plot(count_total.masked,col=cols_tr,add=T,legend=F)
...
pdf(paste0("outputs/all_species/count_nb_species_grad.pdf"))
plot(basemap,col=(pal(1000)), ext=ext_basemap,colNA="dodgerblue3",legend=FALSE,main="Number of species computed by pixel")
plot(maroni_basins,add=T) #Bassins versants noir
draw.shape(maroni_rivs, type = "lines", col = "dodgerblue3", lwd=1)
...
png(paste0("outputs/all_species/count_nb_species_grad.png"))
plot(basemap,col=(pal(1000)), ext=ext_basemap,colNA="dodgerblue3",legend=FALSE,main="Number of species computed by pixel")
plot(maroni_basins,add=T) #Bassins versants noir
draw.shape(maroni_rivs, type = "lines", col = "dodgerblue3", lwd=1)
plot(count_total.masked,col=cols_gr,add=T,legend=F)
...
#list_rasters,maroni_shapefile,myshp.r,n_means,norm_listxyz,rnorm_xyz_total.masked,xyz,cols,cols_gr,v_species,colfunc,pal
